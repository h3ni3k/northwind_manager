		...
		<section>
			<Form {...form}>
				<form action={formAction} className="">
					<div className="w-full">Company Id: {company?.companyId}</div>
					<FormField
						...
						render={({ field }) => (
							<FormItem className="w-full">
								...
								<Select
									...
									value={company?.companyTypeId.toString()}
								>
									<FormControl>
										<SelectTrigger>
						...
						render={({ field }) => (
							<FormItem className="w-full">
								...
								<Select
									name="regionId"
									onValueChange={field.onChange}
									value={company?.regionId.toString()}
								>
									<FormControl>
										<SelectTrigger>
						...
						render={({ field }) => (
							<FormItem className="">
								...
								<Select
									name="taxStatusId"
									onValueChange={field.onChange}
									value={company?.taxStatusId.toString()}
								>
									<FormControl>
										<SelectTrigger>
